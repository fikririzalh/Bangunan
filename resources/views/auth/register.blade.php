                            ...
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                ...
                                <div class="pt-0">
                                    ...
                                    <form method="POST" action="{{ route('register') }}" class="my-4">
                                        ...
                                        <!-- Tambahkan baris ini untuk mengecek jika ada error validasi -->
                                        @if ($errors->any())
                                    ...
                                    <div class="text-center text-muted mb-4">
                                        <p class="mb-0">Alredy Have ab Account?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Log in</a></p>
                                    </div>
